...
include "../class/Masterslider.class.php";
...
if(isset($_GET['deleteid'])){
  $slider->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $slider->isActive($_GET['id'], $_GET['isActive']);
}
$sliderData = $slider->selectData("masterslider"); // select data of menu
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="slider.php" class="active">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Inner Dorm Room</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
       ...
       <?php 
            ...
            <a href="slider-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
              ...
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td> <?php echo $sData['master_slider_title']; ?> </td>
                      <td> <img src="../images/image_slider/<?php echo $sData['master_slider_image_url']; ?>" width="80" height="50" alt="image"> </td>
                      <td> 
                      <a href="slider.php?id= <?php echo $sData['master_slider_id'] . "&isActive=" . $sData['isActive']?>" style ="color: #000">
                         <?php
                          if($sData['isActive'] == 1){
                      ...
                      <td> <a href="slider-edit-form.php?editid= <?php echo $sData['master_slider_id'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="slider.php?deleteid=<?php echo $sData['master_slider_id'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
