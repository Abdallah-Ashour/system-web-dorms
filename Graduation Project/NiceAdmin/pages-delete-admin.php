...
if(isset($_GET['deleteid'])){
  $std->deleteRecords($_GET['deleteid']);
}

$stdData = $std->selectData(); // select data of Admin
...
<a href="pages-add-admin.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Admin</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($stdData as $sData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo $count++;?></td>
                      <td> <?php echo $sData['university_ID']; ?> </td>
                       <td><?php echo $sData['Fname']; ?></td>
                       <td><?php echo $sData['Lname']; ?></td>
                       <td>
                        <?php  if($sData['gender'] == 1)
                                echo "Male";
                               else
                                echo "Female";
                         ?>
                       ...
                       <td>
                       <?php  if($sData['isInternational'] == 1)
                                echo "Yes";
                               else
                                echo "No";
                         ?>
                       </td>
                      <td><a href="pages-delete-admin.php?deleteid=<?php echo $sData['university_ID'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
