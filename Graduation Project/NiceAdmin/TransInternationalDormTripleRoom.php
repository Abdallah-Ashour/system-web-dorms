...
if(isset($_GET['deleteid'])){
  $inernamtionalTripleRoom->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $inernamtionalTripleRoom->isActive($_GET['id'], $_GET['isActive']);    
}

$inernamtionalTripleRoomData = $inernamtionalTripleRoom->SelectRoomData("transinternationaldormTripleroom"); // select data of menu
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inernational Night Room</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<a href="TransinternationaldormTripleRoom-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($inernamtionalTripleRoomData as $iNSRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iNSRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iNSRData['transInternationalDormTripleRoomBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iNSRData['transInternationalDormTripleRoomImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iNSRData['transInternationalDormTripleRoomPrice']; ?></td>

                      <td> 
                      <a href="TransinternationaldormTripleRoom.php?id= <?php echo $iNSRData['transInternationalDormTripleRoomId'] . "&isActive=" . $inernamtionalTripleRoom->getActive($iNSRData['transInternationalDormTripleRoomId'])?>" style ="color: #000">
                         <?php
                          if($inernamtionalTripleRoom->getActive($iNSRData['transInternationalDormTripleRoomId']) == 1){
                      ...
                      <td> <a href="TransinternationaldormTripleRoom-edit-form.php?editid= <?php echo $iNSRData['transInternationalDormTripleRoomId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransinternationaldormTripleRoom.php?deleteid=<?php echo $iNSRData['transInternationalDormTripleRoomId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
