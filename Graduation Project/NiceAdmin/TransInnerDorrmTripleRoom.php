...
$innerTripleRoom = new TransInnerDorrmTripleRoom();

// DeleteRecords 
if(isset($_GET['deleteid'])){
  $innerTripleRoom->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $innerTripleRoom->isActive($_GET['id'], $_GET['isActive']);    
}

$innerTripleRoomData = $innerTripleRoom->SelectRoomData("transinnerdorrmtripleroom"); // select data of menu
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="TransInnerDorrmTripleRoom.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inner Triple Room</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<a href="TransInnerDorrmTripleRoom-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($innerTripleRoomData as $iTRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iTRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iTRData['transInnerDorrmTripleRoomBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iTRData['transInnerDorrmTripleRoomImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iTRData['transInnerDorrmTripleRoomPrice']; ?></td>

                      <td> 
                      <a href="TransInnerDorrmTripleRoom.php?id= <?php echo $iTRData['transInnerDorrmTripleRoomId'] . "&isActive=" . $innerTripleRoom->getActive($iTRData['transInnerDorrmTripleRoomId'])?>" style ="color: #000">
                         <?php
                          if($innerTripleRoom->getActive($iTRData['transInnerDorrmTripleRoomId']) == 1){
                      ...
                      <td> <a href="TransInnerDorrmTripleRoom-edit-form.php?editid= <?php echo $iTRData['transInnerDorrmTripleRoomId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransInnerDorrmTripleRoom.php?deleteid=<?php echo $iTRData['transInnerDorrmTripleRoomId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
