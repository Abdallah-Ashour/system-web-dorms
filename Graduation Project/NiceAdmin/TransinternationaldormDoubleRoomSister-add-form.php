...
// add records
if(isset($_POST['add'])){
    $inernamtionalDoubleRoomSister->insertInternationalDoubleRoomSister($_POST, $_FILES);
  }
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="index.html">Dorms</a></li>
          <li class="breadcrumb-item ">International Triple Room</li>
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            <!-- form to insert data  -->
            <form  action="TransinternationaldormDoubleRoomSister-add-form.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                <select class="form-select" aria-label="Default select example" name="id_dorm">
                    <option selected value="<?php echo $dataDorms[0]['master_domitory_id'] ?>">Select Name Of Dorm</option>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="image_exit">
                </div>
                <br>
