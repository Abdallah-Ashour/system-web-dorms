...
// select data by id
if($_GET['editid'])
$dataNav = $menu->SelectById($_GET['editid']);

// edit Navbar
if(isset($_POST['submit'])){
    $menu->UpdateNav($_POST);
}
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            <div >
                <form  action="navbar-edit-form.php" method="post">
                    <div class="mb-3">
                    <label for="name" class="form-label font-weight-bold"><b>Name</b></label>
                    <input type="text" class="form-control" id="name" name="name" value="<?php echo $dataNav['master_menu_name'] ?>">
                </div>
                <div class="mb-3">
                    <label for="link" class="form-label "><b>Link</b></label>
                    <input type="text" class="form-control" id="link" name="link" value="<?php echo $dataNav['master_menu_url_link'] ?>">
                </div>
  ...
  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio1" value="1" <?php if($dataNav['isActive'] == 1) echo "checked";?>>
...
<div class="form-check form-check-inline" style="margin-right: 5px;">
  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio2" value="0" <?php if($dataNav['isActive'] == 0) echo "checked";?>>
  <label class="form-check-label p-1"  for="inlineRadio2"><b>False</b></label>
</div>
<br> <br>

                <input type="hidden" name="id" value="<?php echo $dataNav['master_menu_id'] ?>">
