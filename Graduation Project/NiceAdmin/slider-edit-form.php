...
// select data by id
if($_GET['editid'])
$dataSlider = $slider->SelectById($_GET['editid']);

// edit Navbar
if(isset($_POST['submit'])){
    $slider->UpdateSlider($_POST, $_FILES);
}
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            <div >
                <form  action="slider-edit-form.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    <label for="name" class="form-label font-weight-bold"><b>Title</b></label>
                    <input type="text" class="form-control" id="name" name="title" value="<?php echo $dataSlider['master_slider_title']?>" >
                </div>

                <div class="form-group">
                  <label for="image"><b>Image:</b></label><br>
                  <input type="file" class="form-control-file" id="image" name="image" value = "dsadas.png">
                  <input type="hidden" name='image_exit' value="<?php echo $dataSlider['master_slider_image_url']; ?>">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio1" value="1" <?php if($dataSlider['isActive'] == 1) echo "checked";?>>
                ...
                <div class="form-check form-check-inline" style="margin-right: 5px;">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio2" value="0" <?php if($dataSlider['isActive'] == 0) echo "checked";?>>
                  <label class="form-check-label p-1"  for="inlineRadio2"><b>False</b></label>
                </div>
                <br> <br>

                <input type="hidden" name="id" value="<?php echo $dataSlider['master_slider_id'] ?>">
