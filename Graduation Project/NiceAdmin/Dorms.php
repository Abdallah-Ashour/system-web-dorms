...
if(isset($_GET['deleteid'])){
  $dorm->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $dorm->isActive($_GET['id'], $_GET['isActive']);
}

$dormData = $dorm->selectData("masterdormitory"); // select data of menu
...
<a href="dorm-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($dormData as $dData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo $count++;?></td>
                      <td> <?php echo $dData['master_domitory_name']; ?> </td>
                       <td> <img src="../images/image_dorm/<?php echo $dData['master_domitory_image']; ?>" width="80" height="50" alt="image"> </td>
                       <td class="text-black-50 text-md-start fw-light" style="line-height: 1.7; text-align: justify !important;  font-size: 16px; "><?php echo $dData['master_domitory_brief']; ?></td>
                       <td colspan="5"><?php echo $dData['master_domitory_link_url']; ?></td>
                       <td><a href="<?php echo $dData['master_domitory_link_map']; ?>" target="_blank"><?php echo $dData['master_domitory_link_map']; ?></a></td>
                           <?php if($dData['isInternational'] == 1)
                      ...
                      <td> 
                      <a href="Dorms.php?id= <?php echo $dData['master_domitory_id'] . "&isActive=" . $dData['isActive']?>" style ="color: #000">
                         <?php
                          if($dData['isActive'] == 1){
                      ...
                      <td> <a href="dorm-edit-form.php?editid= <?php echo $dData['master_domitory_id'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="Dorms.php?deleteid=<?php echo $dData['master_domitory_id'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
