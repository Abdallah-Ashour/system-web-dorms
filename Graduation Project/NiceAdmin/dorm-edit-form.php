...
if(isset($_POST['submit'])){
    $dorm->UpdateDorm($_POST, $_FILES);
}
if($_GET['editid'])
$dataDorms = $dorm->SelectById($_GET['editid']);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            ...
            <div >
                <form  action="dorm-edit-form.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    <label for="name" class="form-label font-weight-bold"><b>Name:</b></label>
                    <input type="text" class="form-control" id="name" name="name" value="<?php echo $dataDorms['master_domitory_name'] ?>">
                </div>

                <div class="mb-3">
                    <label for="brief" class="form-label font-weight-bold"><b>Brief:</b></label>
                    <input type="text" class="form-control" id="brief" name="brief" value="<?php echo $dataDorms['master_domitory_brief'] ?>">
                </div>

                <div class="mb-3">
                    <label for="linkDorm" class="form-label "><b>Link Dorm:</b></label>
                    <input type="text" class="form-control" id="linkDorm" name="linkDorm" value="<?php echo $dataDorms['master_domitory_link_url'] ?>">
                </div>

                <div class="mb-3">
                    <label for="linkMap" class="form-label "><b>Link Map:</b></label>
                    <input type="text" class="form-control" id="linkMap" name="linkMap" value="<?php echo $dataDorms['master_domitory_link_map'] ?>">
                </div>
                <label><b>International:</b></label>
                <br>
                <input type="hidden" name="internationalDefault" value="<?php echo $dataDorms['isInternational']; ?>">

                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="isInternational" id="inlineRadio1" value="1" <?php if($dataDorms['isInternational'] == 1) echo "checked";?>>
                ...
                <div class="form-check form-check-inline" style="margin-right: 5px;">
                  <input class="form-check-input" type="radio" name="isInternational" id="inlineRadio2" value="0" <?php if($dataDorms['isInternational'] == 0) echo "checked";?>>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name='image_exit' value="<?php echo $dataDorms['master_domitory_image'] ?>">
                ...
                <br>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio1" value="1" <?php if($dataDorms['isActive'] == 1) echo "checked";?>>
                  <label class="form-check-label p-1" style="margin-right: 5px;" for="inlineRadio1"><b>True</b></label>
                </div>
                <br>
                <div class="form-check form-check-inline" style="margin-right: 5px;">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio2" value="0" <?php if($dataDorms['isActive'] == 0) echo "checked";?>>
                  <label class="form-check-label p-1"  for="inlineRadio2"><b>False</b></label>
                </div>
                <br> <br>

                <input type="hidden" name="id" value="<?php echo $dataDorms['master_domitory_id'] ?>">
