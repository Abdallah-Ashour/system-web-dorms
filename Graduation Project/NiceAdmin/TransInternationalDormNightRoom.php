...
if(isset($_GET['deleteid'])){
  $inernamtionalNightRoom->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $inernamtionalNightRoom->isActive($_GET['id'], $_GET['isActive']);    
}

$inernamtionalNightRoomData = $inernamtionalNightRoom->SelectRoomData("transinternationaldormNightroom"); // select data of menu
...
<a href="TransinternationaldormNightRoom-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($inernamtionalNightRoomData as $iNSRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iNSRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iNSRData['transInternationalDormNightRoomBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iNSRData['transInternationalDormNightRoomImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iNSRData['transInternationalDormNightRoomPrice']; ?></td>

                      <td> 
                      <a href="TransinternationaldormNightRoom.php?id= <?php echo $iNSRData['transInternationalDormNightRoomId'] . "&isActive=" . $inernamtionalNightRoom->getActive($iNSRData['transInternationalDormNightRoomId'])?>" style ="color: #000">
                         <?php
                          if($inernamtionalNightRoom->getActive($iNSRData['transInternationalDormNightRoomId']) == 1){
                      ...
                      <td> <a href="TransinternationaldormNightRoom-edit-form.php?editid= <?php echo $iNSRData['transInternationalDormNightRoomId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransinternationaldormNightRoom.php?deleteid=<?php echo $iNSRData['transInternationalDormNightRoomId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
