...
// add records
if(isset($_POST['add'])){
    $inernamtionalTripleRoom->insertInternationalTripleRoom($_POST, $_FILES);
  }
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            <!-- form to insert data  -->
            <form  action="TransinternationaldormTripleRoom-add-form.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
