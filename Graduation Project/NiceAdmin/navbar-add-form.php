...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            <div >
                <form  action="navbar-add-form.php" method="post">
                    <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary" name="submit" value="add">Insert</button>
