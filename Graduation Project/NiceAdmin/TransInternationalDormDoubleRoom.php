...
if(isset($_GET['deleteid'])){
  $inernamtionalDoubleRoom->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $inernamtionalDoubleRoom->isActive($_GET['id'], $_GET['isActive']);    
}

$inernamtionalDoubleRoomData = $inernamtionalDoubleRoom->SelectRoomData("transinternationaldormDoubleroom"); // select data of menu
$std = new Student();
...
<head>
  ...
  <title>International Dorm Double Room</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inernational Double Room</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<a href="TransinternationaldormDoubleRoom-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($inernamtionalDoubleRoomData as $iNSRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iNSRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iNSRData['transInternationalDormDoubleRoomBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iNSRData['transInternationalDormDoubleRoomImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iNSRData['transInternationalDormDoubleRoomPrice']; ?></td>

                      <td> 
                      <a href="TransinternationaldormDoubleRoom.php?id= <?php echo $iNSRData['transInternationalDormDoubleRoomId'] . "&isActive=" . $inernamtionalDoubleRoom->getActive($iNSRData['transInternationalDormDoubleRoomId'])?>" style ="color: #000">
                         <?php
                          if($inernamtionalDoubleRoom->getActive($iNSRData['transInternationalDormDoubleRoomId']) == 1){
                      ...
                      <td> <a href="TransinternationaldormDoubleRoom-edit-form.php?editid= <?php echo $iNSRData['transInternationalDormDoubleRoomId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransinternationaldormDoubleRoom.php?deleteid=<?php echo $iNSRData['transInternationalDormDoubleRoomId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
