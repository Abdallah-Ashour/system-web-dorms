...
$inernamtionalDoubleRoomSister = new TransInternationalDormDoubleRoomSister();

// DeleteRecords 
if(isset($_GET['deleteid'])){
  $inernamtionalDoubleRoomSister->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $inernamtionalDoubleRoomSister->isActive($_GET['id'], $_GET['isActive']);    
}

$inernamtionalDoubleRoomSisterData = $inernamtionalDoubleRoomSister->SelectRoomData("transinternationaldormDoubleRoomSister"); // select data of menu
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="TransInternationalDormDoubleRoomSister.php"  class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inernational Double Room (Two Sister)</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<a href="TransinternationaldormDoubleRoomSister-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($inernamtionalDoubleRoomSisterData as $iNSRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iNSRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iNSRData['transInternationalDormDoubleRoomSisterBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iNSRData['transInternationalDormDoubleRoomSisterImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iNSRData['transInternationalDormDoubleRoomSisterPrice']; ?></td>

                      <td> 
                      <a href="TransinternationaldormDoubleRoomSister.php?id= <?php echo $iNSRData['transInternationalDormDoubleRoomSisterId'] . "&isActive=" . $inernamtionalDoubleRoomSister->getActive($iNSRData['transInternationalDormDoubleRoomSisterId'])?>" style ="color: #000">
                         <?php
                          if($inernamtionalDoubleRoomSister->getActive($iNSRData['transInternationalDormDoubleRoomSisterId']) == 1){
                      ...
                      <td> <a href="TransinternationaldormDoubleRoomSister-edit-form.php?editid= <?php echo $iNSRData['transInternationalDormDoubleRoomSisterId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransinternationaldormDoubleRoomSister.php?deleteid=<?php echo $iNSRData['transInternationalDormDoubleRoomSisterId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
