...
if(isset($_GET['deleteid'])){
  $menu->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $menu->isActive($_GET['id'], $_GET['isActive']);
}
$menuData = $menu->selectData("mastermenu"); // select data of menu
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="navbar-footer.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
            ...
            <?php } ?> 
            <a href="navbar-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
              ...
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td> <?php echo $mData['master_menu_name']; ?> </td>
                      <td> <?php echo $mData['master_menu_url_link']; ?> </td>
                      <?php if($mData['master_menu_dropmenu'] == 1)
                                   echo "<td class='text-primary'>Yes</td>";
                                  else
                                   echo "<td class='text-danger'>No</td>";?>
                        </td>
                      <td> 
                      <a href="navbar-footer.php?id= <?php echo $mData['master_menu_id'] . "&isActive=" . $mData['isActive']?>" style ="color: #000">
                      ...
                      <td> <a href="navbar-edit-form.php?editid= <?php echo $mData['master_menu_id'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="navbar-footer.php?deleteid=<?php echo $mData['master_menu_id'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
