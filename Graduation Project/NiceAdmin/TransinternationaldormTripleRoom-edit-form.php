...
$inernamtionalTripleRoom = new TransInternationalDormTripleRoom();

// select data id and name of dorms
$dataDorms = $inernamtionalTripleRoom->selectNameIdofRoom(1);  

// edit Navbar
if(isset($_POST['submit'])){
    $inernamtionalTripleRoom->UpdateInernatinalTripleRoom($_POST, $_FILES);
}
if($_GET['editid'])
$datainernamtionalTripleRoom = $inernamtionalTripleRoom->SelectById($_GET['editid']);
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="TransInternationalDormTripleRoom.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.html">Inernational Triple Room </a></li>
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            ...
            <div >
                <form  action="TransinternationaldormTripleRoom-edit-form.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                <select class="form-select" aria-label="Default select example" name="id_dorm">
                    <option selected value="<?php echo $datainernamtionalTripleRoom['master_domitory_id'] ?>">Select Name Of Dorm</option>
                   ...
                   <?php } ?>
                    ...
                    <input type="text" class="form-control" id="name" name="title" value="<?php echo $datainernamtionalTripleRoom['transInternationalDormTripleRoomTitle'] ?>">
                </div>

                <div class="mb-3">
                    <label for="brief" class="form-label font-weight-bold"><b>Brief:</b></label>
                    <input type="text" class="form-control" id="brief" name="brief" value="<?php echo $datainernamtionalTripleRoom['transInternationalDormTripleRoomBrief'] ?>">
                </div>
                
                <div class="form-group">
                  <label for="iamge"><b>Image:</b></label><br>
                  <input type="file" class="form-control-file" id="image" name="image">
                  <input type="hidden" name="image_exit" value="<?php echo $datainernamtionalTripleRoom['transInternationalDormTripleRoomImage']; ?>">
                </div>
                <br>

                <div class="mb-3">
                    <label for="price" class="form-label "><b>Price:</b></label>
                    <input type="number" class="form-control" id="price" name="price" value="<?php echo $datainernamtionalTripleRoom['transInternationalDormTripleRoomPrice'] ?>">
                </div>
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio1" value="1" <?php if($datainernamtionalTripleRoom['isActive'] == 1) echo "checked";?>>
                ...
                <div class="form-check form-check-inline" style="margin-right: 5px;">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio2" value="0" <?php if($datainernamtionalTripleRoom['isActive'] == 0) echo "checked";?>>
                  <label class="form-check-label p-1"  for="inlineRadio2"><b>False</b></label>
                </div>
                <br> <br>

                <input type="hidden" name="id" value="<?php echo $datainernamtionalTripleRoom['transInternationalDormTripleRoomId'] ?>">
