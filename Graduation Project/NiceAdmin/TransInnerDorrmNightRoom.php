...
if(isset($_GET['deleteid'])){
  $innerNightRoom->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $innerNightRoom->isActive($_GET['id'], $_GET['isActive']);    
}

$innerNightRoomData = $innerNightRoom->SelectRoomData("transinnerdorrmnight"); // select data of menu
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inner Night Room</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<a href="TransInnerDorrmNightRoom-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($innerNightRoomData as $iNRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iNRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iNRData['transInnerDorrmNightRoomBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iNRData['transInnerDorrmNightRoomImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iNRData['transInnerDorrmNightRoomPrice']; ?></td>

                      <td> 
                      <a href="TransInnerDorrmNightRoom.php?id= <?php echo $iNRData['transInnerDorrmNightId'] . "&isActive=" . $innerNightRoom->getActive($iNRData['transInnerDorrmNightId'])?>" style ="color: #000">
                         <?php
                          if($innerNightRoom->getActive($iNRData['transInnerDorrmNightId']) == 1){
                      ...
                      <td> <a href="TransInnerDorrmNightRoom-edit-form.php?editid= <?php echo $iNRData['transInnerDorrmNightId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransInnerDorrmNightRoom.php?deleteid=<?php echo $iNRData['transInnerDorrmNightId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
