...
$dataDorms = $innerDoubleRoom->selectNameIdofRoom(0);  

// edit Navbar
if(isset($_POST['submit'])){
    $innerDoubleRoom->UpdateInnerDoubleRoom($_POST, $_FILES);
}
if($_GET['editid'])
$dataInnerDoubleRoom = $innerDoubleRoom->SelectById($_GET['editid']);
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            ...
            <div >
                <form  action="TransInnerDorrmDoubleRoom-edit-form.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                <select class="form-select" aria-label="Default select example" name="id_dorm">
                    <option selected value="<?php echo $dataInnerDoubleRoom['master_domitory_id'] ?>">Select Name Of Dorm</option>
                   ...
                   <?php } ?>
                    ...
                    <input type="text" class="form-control" id="name" name="title" value="<?php echo $dataInnerDoubleRoom['transInnerDorrmDoubleRoomTitle'] ?>">
                </div>

                <div class="mb-3">
                    <label for="brief" class="form-label font-weight-bold"><b>Brief:</b></label>
                    <input type="text" class="form-control" id="brief" name="brief" value="<?php echo $dataInnerDoubleRoom['transInnerDorrmDoubleRoomBrief'] ?>">
                </div>
                
                <div class="form-group">
                  <label for="iamge"><b>Image:</b></label><br>
                  <input type="file" class="form-control-file" id="image" name="image">
                  <input type="hidden" name="image_exit" value="<?php echo $dataInnerDoubleRoom['transInnerDorrmDoubleRoomImage']; ?>">
                </div>
                <br>

                <div class="mb-3">
                    <label for="price" class="form-label "><b>Price:</b></label>
                    <input type="number" class="form-control" id="price" name="price" value="<?php echo $dataInnerDoubleRoom['transInnerDorrmDoubleRoomPrice'] ?>">
                </div>
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio1" value="1" <?php if($dataInnerDoubleRoom['isActive'] == 1) echo "checked";?>>
                ...
                <div class="form-check form-check-inline" style="margin-right: 5px;">
                  <input class="form-check-input" type="radio" name="isActive" id="inlineRadio2" value="0" <?php if($dataInnerDoubleRoom['isActive'] == 0) echo "checked";?>>
                  <label class="form-check-label p-1"  for="inlineRadio2"><b>False</b></label>
                </div>
                <br> <br>

                <input type="hidden" name="id" value="<?php echo $dataInnerDoubleRoom['transInnerDorrmDoubleRoomId'] ?>">
