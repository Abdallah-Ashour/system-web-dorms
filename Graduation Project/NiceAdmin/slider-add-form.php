...
// add records
if(isset($_POST['add'])){
    $slider->insertSlider($_POST, $_FILES);
  }
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            ...
            <form  action="slider-add-form.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
            ...
            <br>
              ...
              <button type="submit" class="btn btn-primary" name="add" value="submit">Insert</button>
