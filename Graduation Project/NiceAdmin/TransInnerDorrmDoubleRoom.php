...
$innerDoubleRoom = new TransInnerDorrmDoubleRoom();

// DeleteRecords 
if(isset($_GET['deleteid'])){
  $innerDoubleRoom->deleteRecords($_GET['deleteid']);
}
// Active Records
if(isset($_GET['isActive']) && isset($_GET['id'])){
    $innerDoubleRoom->isActive($_GET['id'], $_GET['isActive']);    
}

$innerDoubleRoomData = $innerDoubleRoom->SelectRoomData("transinnerdorrmdoubleroom"); // select data of menu
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Inner Dorms</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="TransInnerDorrmDoubleRoom.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inner Double Room</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<a href="TransInnerDorrmDoubleRoom-add-form.php" class="btn btn-primary mb-3" rel="noopener noreferrer">Add New Records</a>
            ...
            <div class="table-responsive">
              <table class="table table-bordered  table-hover">
                  ...
                  <tbody>
                    <?php 
                     $count = 1;
                     foreach($innerDoubleRoomData as $iDRData){
                    ?>
                    <tr class="text-center">
                      <td><?php echo "Room" . $count++;?></td>
                      <td> <?php echo $iDRData['master_domitory_name']; ?> </td>
                      <td><?php echo $iDRData['transInnerDorrmDoubleRoomBrief']; ?></td>
                       <td> <img src="../images/image_inner/<?php echo $iDRData['transInnerDorrmDoubleRoomImage']; ?>" width="80" height="50" alt="image"> </td>
                       <td> <?php echo $iDRData['transInnerDorrmDoubleRoomPrice']; ?></td>

                      <td> 
                      <a href="TransInnerDorrmDoubleRoom.php?id= <?php echo $iDRData['transInnerDorrmDoubleRoomId'] . "&isActive=" . $innerDoubleRoom->getActive($iDRData['transInnerDorrmDoubleRoomId'])?>" style ="color: #000">
                         <?php
                          if($innerDoubleRoom->getActive($iDRData['transInnerDorrmDoubleRoomId']) == 1){
                      ...
                      <td> <a href="TransInnerDorrmDoubleRoom-edit-form.php?editid= <?php echo $iDRData['transInnerDorrmDoubleRoomId'];?>" style ="color: #000"><i class="fa-sharp fa-2x fa-solid fa-pen-to-square"></i></a> </td>
                      <td><a href="TransInnerDorrmDoubleRoom.php?deleteid=<?php echo $iDRData['transInnerDorrmDoubleRoomId'];?>&dm=Delete Records Successfully" onclick = "return confirm('Are you sure to delete?')" >
