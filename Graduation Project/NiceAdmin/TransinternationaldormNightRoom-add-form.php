...
// add records
if(isset($_POST['add'])){
    $inernamtionalNightRoom->insertInternationalNightRoom($_POST, $_FILES);
  }
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        ...
        <li class="breadcrumb-item"><a href="index.html">Dorms</a></li>
          <li class="breadcrumb-item ">International Night Room</li>
    ...
    <section class="section bg-white p-4 rounded" style="width: 30%;">
            <!-- form to insert data  -->
            <form  action="TransinternationaldormNightRoom-add-form.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
